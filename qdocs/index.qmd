...
#| output: false
using Plots
default(bottom_margin=3Plots.mm, right_margin=5Plots.mm)
```
...
- **Building** covers [Verilog output](compiling.qmd), [boards and constraints](boards.qmd) and the [timing report](timing.qmd).
