...
plus the special registers of later chapters — `Pulse`, `Timeout{N}`, `Edge`, `MetaGuard{K}`, `Pipeline{K,T}`, `Multicycle{K,T}`, `Pad{N}` — and other `@quartz` modules, which make an instance.
