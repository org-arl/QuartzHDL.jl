...
::: {.callout-important title="If you know Julia"}
...
The 128-bit cap is a limit of the implementation, which keeps every value in one machine word, and not of the language; wider data — a sample window, a packet buffer — is several registers or a [`RAM`](library.qmd).
