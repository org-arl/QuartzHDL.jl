...
**A small design, from description to Verilog**
...
using Plots
default(size=(650, 250), bottom_margin=3Plots.mm, right_margin=5Plots.mm)
```
...
The high pulses are narrow before 1 ms and wide after it. [Simulation](simulating.qmd) covers the rest of this: watching specific nets, waiting on conditions, running tasks alongside the stimulus, and a REPL prompt for interactive poking.
